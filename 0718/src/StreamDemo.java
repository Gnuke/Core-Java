 ...
 *  5. 중간연산의 결과가 Stream으로 리턴되기 때문에 Stream 연산을 계속 이어서 chain 형태로 이용할 수 있다.
...
public class StreamDemo {
	public static void main(String[] args) {
		// Stream 생성 : 배열을 이용할 것인가, Collection을 이용할 것인가에 따라 약간 다르다.
		...
		DoubleStream ds1 = new Random().doubles( 15L, 1.0, 10.0); // ( 개수, ~부터, ~까지 )
